...
class PipelineConfig:
    ...
    # Database settings
    db_host: str = None  # Will be loaded from environment or config
    db_port: int = None  # Will be loaded from environment or config
    db_name: str = None  # Will be loaded from environment or config
