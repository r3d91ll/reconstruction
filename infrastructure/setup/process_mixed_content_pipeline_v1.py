...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('mixed_content_pipeline_v1.log')
    ]
)
...
class ImportAnalyzer:
    ...
    def _is_third_party(self, module: str) -> bool:
        """Check if module is a known third-party library"""
        third_party = {
...
class CodeProcessor:
    ...
    def extract_python_units(self, file_path: Path, content: str, repo_root: Path = None) -> Tuple[List[CodeUnit], Dict[str, Any]]:
        ...
        try:
            ...
            file_metadata = {
                'ast_metadata': {'parse_error': str(e)},
                'filesystem_metadata': fs_metadata,
                'semantic_patterns': {},
...
def main():
    ...
    config = PipelineConfig(
        ...
        pdf_workers=args.pdf_workers if args.pdf_dir else 0,
