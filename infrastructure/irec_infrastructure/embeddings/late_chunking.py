...
class LateChucker:
    ...
    def _create_semantic_chunks(
        ...
        # Split by sections (## headers) with regex to handle beginning of document
        ...
        for section_idx, section in enumerate(sections):
            ...
            for paragraph in paragraphs:
                ...
                if paragraph_size > self.target_chunk_size:
                    # Use proper sentence splitting to handle abbreviations
                    # Simple regex that handles common cases
